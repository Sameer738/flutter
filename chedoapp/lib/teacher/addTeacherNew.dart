...
class AddTeacherNew extends StatefulWidget {
  @override
  _AddTeacherNewState createState() => _AddTeacherNewState();
}

class _AddTeacherNewState extends State<AddTeacherNew> {
                        ...
                        ListTile(
                          title: TextField(
                            ...
                            decoration: InputDecoration(
                              ...
                              errorText: !validator7
                                  ? "Salary Should be greater than 99 rs"
                                  : null,
                              border: OutlineInputBorder(
                                borderRadius: BorderRadius.circular(25),
                              ),
