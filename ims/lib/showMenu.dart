...
import 'package:ims/course.dart';
import 'package:ims/course_module/courseList.dart';
import 'package:ims/course_module/courseMenu.dart';
...
import 'package:ims/student_module/studentMenu.dart';
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: ListTile(
                onTap: () {
                  Navigator.push(context,
                      MaterialPageRoute(builder: (context) => CourseMenu()));
                },
                leading: Icon(
                  Icons.book,
                  color: Colors.white,
